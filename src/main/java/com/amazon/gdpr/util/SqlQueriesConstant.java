...
public class SqlQueriesConstant {
	...
	public static String MODULE_MGMT_LAST_RUN = "SELECT RMM.MODULE_ID, RMM.RUN_ID, RMM.MODULE_NAME, RMM.SUBMODULE_NAME, RMM.MODULE_STATUS, "
			...
			+ "RM.RUN_STATUS = 'RE-RUN' AND RM.RUN_ID = ? ORDER BY RMM.MODULE_ID DESC";
	...
	public static String COUNTRY_EMP_FETCH = "SELECT REGION, COUNTRY_CODE FROM GDPR.COUNTRY WHERE "
			+ " COUNTRY_CODE IN (%s) ORDER BY REGION, COUNTRY_CODE ASC";
	...
	public static String IMPACT_FIELD_FETCH = "SELECT IMPACT_FIELD_ID, IMPACT_TABLE_ID, IMPACT_FIELD_LABEL, "
			+ " IMPACT_FIELD_NAME, IMPACT_FIELD_TYPE FROM GDPR.IMPACT_FIELD WHERE STATUS = 'ACTIVE'";
	
	public static String ANONYMIZATION_DETAIL_FETCH = "SELECT IMPACT_FIELD_ID, "
			+ " CATEGORY_ID, REGION, COUNTRY_CODE, TRANSFORMATION_TYPE, STATUS FROM GDPR.ANONYMIZATION_DETAIL WHERE STATUS = 'ACTIVE'";
	...
	public static String SUMMARY_DATA_FETCH = "SELECT DISTINCT AD.CATEGORY_ID CATEGORY_ID, AD.REGION REGION, RA.COUNTRY_CODE COUNTRY_CODE, "
			...
			+" AND AD.STATUS = 'ACTIVE' AND IF.STATUS = 'ACTIVE' AND CAT.STATUS = 'ACTIVE' "
	...
	public static String IMPACT_FIELD_INSERT = "INSERT INTO GDPR.IMPACT_FIELD (IMPACT_TABLE_ID, "
			+ " IMPACT_FIELD_LABEL, IMPACT_FIELD_NAME, IMPACT_FIELD_TYPE, STATUS) VALUES (?, ?, ?, UPPER(?), 'ACTIVE')";
	...
	public static String RUN_ANONYMIZATION_INSERT = "INSERT INTO GDPR.RUN_ANONYMIZATION (RUN_ID, COUNTRY_CODE, ANONYMIZATION_DETAIL_ID) "
			...
			+ " COUNTRY_CODE = ?) AND CATEGORY_ID IN (SELECT CATEGORY_ID FROM GDPR.CATEGORY WHERE RECORD_TYPE=?)";
	...
	public static String RUN_SUMMARY_MGMT_LIST_FETCH = "SELECT SUMMARY_ID, RUN_ID, CATEGORY_ID, COUNTRY_CODE, IMPACT_TABLE_ID, IMPACT_TABLE_NAME, "
			+ " BACKUP_QUERY, DEPERSONALIZATION_QUERY, TAGGED_QUERY FROM GDPR.RUN_SUMMARY_MGMT WHERE RUN_ID = ? AND "
			+ " (TAGGED_ROW_COUNT IS NULL OR TAGGED_ROW_COUNT < BACKUP_ROW_COUNT) "
			+ "ORDER BY RUN_ID, SUMMARY_ID";
	...
	public static String BACKUPTABLE_COLUMNS_QRY	= "SELECT TABLE_NAME,COLUMN_NAME FROM INFORMATION_SCHEMA.COLUMNS WHERE "
			+ "LOWER(TABLE_SCHEMA) = LOWER('BKP')";
	
	public static String IMPACTTABLE_DETAILS_QRY	= "SELECT T1.IMPACT_TABLE_NAME, T2.IMPACT_FIELD_NAME,  T2.IMPACT_FIELD_TYPE FROM "
			+ "GDPR.IMPACT_TABLE T1 JOIN  GDPR.IMPACT_FIELD T2 ON T1.IMPACT_TABLE_ID = T2.IMPACT_TABLE_ID WHERE T2.STATUS='ACTIVE';";	
...
//	public static String DATA_LOAD_UPDATE = "UPDATE GDPR.DATA_LOAD SET LAST_DATA_LOADED_DATE = "
	...
	public static String DATA_LOAD_UPDATE = "UPDATE GDPR.DATA_LOAD SET LAST_DATA_LOADED_DATE = "
			+ "(SELECT DATA_LOAD_DATE FROM GDPR.RUN_MGMT WHERE RUN_ID = ? ) WHERE STATUS='ACTIVE'";
	...
	public static String IMPACTFIELD_ANONYMIZATION_DETAIL_FETCH = "SELECT IT.IMPACT_TABLE_NAME, IF.IMPACT_FIELD_NAME,  AD.TRANSFORMATION_TYPE FROM GDPR.IMPACT_TABLE IT ,GDPR.IMPACT_FIELD IF, GDPR.ANONYMIZATION_DETAIL AD WHERE "
			+ "IT.IMPACT_TABLE_ID = IF.IMPACT_TABLE_ID AND IF.IMPACT_FIELD_ID = AD.IMPACT_FIELD_ID";
		
	public static String GDPR_HEROKU_TAGGING_FETCH = "SELECT * FROM SALESFORCE.GDPR_HEROKU_TAGGING__C WHERE HEROKU_STATUS__C = '' OR HEROKU_STATUS__C IS NULL";
	
	/*public static String GDPR_COUNTRIES_FETCH = "(SELECT DISTINCT GD.COUNTRY_CODE__C FROM SF_COPY.GDPR_DEPERSONALIZATION__C GD, GDPR.RUN_MGMT RM "
			...
			+ "(GD.CREATEDDATE >= RM.PREV_DATA_LOAD_DATETIME OR GD.LASTMODIFIEDDATE >= RM.PREV_DATA_LOAD_DATETIME) AND "
			+ "GD.CREATEDDATE < RM.DATA_LOAD_DATETIME AND RM.RUN_ID = ?) UNION "
			+ "(SELECT DISTINCT GD.COUNTRY_CODE__C FROM SF_COPY.GDPR_EMPLOYEE_DEPERSONALIZATION__C GD, GDPR.RUN_MGMT RM WHERE "
			+ "(GD.BIO_PHOTO_STATUS__C IN ('Sent') OR GD.STAFF_EXP_STATUS__C IN ('Sent') OR GD.MASTER_DATA_STATUS__C IN ('Sent')) AND "
			+ "(GD.CREATEDDATE >= RM.PREV_DATA_LOAD_DATETIME OR GD.LASTMODIFIEDDATE >= RM.PREV_DATA_LOAD_DATETIME) AND "
			+ "GD.CREATEDDATE < RM.DATA_LOAD_DATETIME AND RM.RUN_ID =?) ";*/
	
	
	public static String GDPR_COUNTRIES_FETCH = "(SELECT DISTINCT GD.COUNTRY_CODE__C FROM SF_COPY.GDPR_DEPERSONALIZATION__C GD, GDPR.RUN_MGMT RM, GDPR.DATA_LOAD DL "
			+ "WHERE (GD.BGC_STATUS__C IN ('DEPERSONALIZATION_COMPLETE', 'DEPERSON_NO_TASK_COMPLETE') OR "
			+ "GD.PH_AMAZON_ASSESSMENT_STATUS__C IN ('DEPERSONALIZATION_COMPLETE', 'DEPERSON_NO_TASK_COMPLETE') OR "
			+ "GD.PH_CANDIDATE_PROVIDED_STATUS__C IN ('DEPERSONALIZATION_COMPLETE', 'DEPERSON_NO_TASK_COMPLETE') OR "
			+ "GD.PH_MASTER_DATA_STATUS__C IN ('DEPERSONALIZATION_COMPLETE', 'DEPERSON_NO_TASK_COMPLETE') OR "
			+ "GD.PH_WITH_CONSENT_STATUS__C IN ('DEPERSONALIZATION_COMPLETE', 'DEPERSON_NO_TASK_COMPLETE')) AND "
			+ "(GD.CREATEDDATE >= DL.LAST_DATA_LOADED_DATE OR GD.LASTMODIFIEDDATE >= DL.LAST_DATA_LOADED_DATE) AND "
			+ "GD.CREATEDDATE < RM.DATA_LOAD_DATE AND DL.STATUS='ACTIVE' AND RM.RUN_ID = ?) UNION "
			+ "(SELECT DISTINCT GD.COUNTRY_CODE__C FROM SF_COPY.GDPR_DEPERSONALIZATION__C GD, GDPR.RUN_MGMT RM, GDPR.DATA_LOAD DL WHERE "
			+ "(GD.CREATEDDATE >= DL.LAST_DATA_LOADED_DATE OR GD.LASTMODIFIEDDATE >= DL.LAST_DATA_LOADED_DATE) AND "
			+ "GD.CREATEDDATE < RM.DATA_LOAD_DATE AND (GD.CANDIDATE__C IS NULL OR GD.CANDIDATE__C='') AND (GD.BGC_STATUS__C IS NULL OR GD.BGC_STATUS__C='') AND CANDIDATE_SFDC_ID__C IS NOT NULL AND DL.STATUS='ACTIVE' AND RM.RUN_ID =?) ";
	public static String GDPR_EMPLOYEE_COUNTRIES_FETCH = "(SELECT DISTINCT GD.COUNTRY_CODE__C FROM SF_COPY.GDPR_EMPLOYEE_DEPERSONALIZATION__C GD, GDPR.RUN_MGMT RM, GDPR.DATA_LOAD DL WHERE "
			+ "(GD.BIO_PHOTO_STATUS__C IN ('Sent') OR GD.STAFF_EXP_STATUS__C IN ('Sent') OR GD.MASTER_DATA_STATUS__C IN ('Sent')) AND "
			+ "(GD.CREATEDDATE >= DL.LAST_DATA_LOADED_DATE OR GD.LASTMODIFIEDDATE >= DL.LAST_DATA_LOADED_DATE) AND "
			+ "GD.CREATEDDATE < RM.DATA_LOAD_DATE AND DL.STATUS='ACTIVE' AND RM.RUN_ID =?) UNION "
			+ "(SELECT DISTINCT GD.COUNTRY_CODE__C FROM SF_COPY.GDPR_EMPLOYEE_DEPERSONALIZATION__C GD, GDPR.RUN_MGMT RM, GDPR.DATA_LOAD DL WHERE "
			+ "(GD.CREATEDDATE >= DL.LAST_DATA_LOADED_DATE OR GD.LASTMODIFIEDDATE >= DL.LAST_DATA_LOADED_DATE) AND "
			+ "GD.CREATEDDATE < RM.DATA_LOAD_DATE AND (GD.CANDIDATE__C IS NULL OR GD.CANDIDATE__C='') AND GD.CANDIDATE_SFDC_ID__C IS NOT NULL AND DL.STATUS='ACTIVE' AND RM.RUN_ID =?) ";
	
	
public static String SF_COPY_COLUMNS_QRY	= "SELECT TABLE_NAME,COLUMN_NAME FROM INFORMATION_SCHEMA.COLUMNS WHERE "
			+ "LOWER(TABLE_SCHEMA) = LOWER('SF_COPY')";
	public static String LAST_DATA_LOADED_DATE_FETCH = "SELECT MAX(DATA_LOAD_DATE)  FROM GDPR.RUN_MGMT WHERE RUN_STATUS = 'SUCCESS'";

	public static String RUN_MGMT_UPDATE = "UPDATE GDPR.RUN_MGMT SET RUN_STATUS = ? WHERE RUN_ID = ?";
}