...
public class SqlQueriesConstant {
	...
	public static String SUMMARY_DATA_FETCH = "SELECT DISTINCT AD.CATEGORY_ID CATEGORY_ID, "
			...
			+" AND AD.STATUS = 'ACTIVE' AND IF.STATUS = 'ACTIVE' AND CAT.STATUS = 'ACTIVE' AND CTY.STATUS = 'ACTIVE' "
			+" AND AD.ANONYMIZATION_DETAIL_ID = RA.ANONYMIZATION_DETAIL_ID AND RA.RUN_ID = ? "			
			+" ORDER BY AD.CATEGORY_ID, IF.IMPACT_TABLE_ID ";
