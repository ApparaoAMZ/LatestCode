...
public class ReorganizeInputMergeRecCompletionListener extends JobExecutionListenerSupport {
	...
	public ReorganizeInputMergeRecCompletionListener(String jobRelatedName) {
	...
	public void afterJob(JobExecution jobExecution) {		
		...
		try {
			...
			RunModuleMgmt runModuleMgmt = new RunModuleMgmt(runId, GlobalConstants.MODULE_INITIALIZATION, GlobalConstants.SUB_MODULE_REORGANIZE_MERGEREC_DATA,
