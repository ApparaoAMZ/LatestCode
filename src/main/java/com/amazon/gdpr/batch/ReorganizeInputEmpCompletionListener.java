...
public class ReorganizeInputEmpCompletionListener extends JobExecutionListenerSupport {
	...
	public ReorganizeInputEmpCompletionListener(String jobRelatedName) {
	...
	public void afterJob(JobExecution jobExecution) {		
		...
		try {
			...
			RunModuleMgmt runModuleMgmt = new RunModuleMgmt(runId, GlobalConstants.MODULE_INITIALIZATION, GlobalConstants.SUB_MODULE_REORGANIZE_EMP_DATA,
